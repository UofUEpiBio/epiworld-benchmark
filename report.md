...
> The committed full-profile result artifacts predate this Covasim
> restriction. Rerun `make benchmark` and `make report` before using
> them to compare the revised design.
