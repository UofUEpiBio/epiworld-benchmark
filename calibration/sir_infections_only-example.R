...
abm_hist_feat <- prepare_data_infections_only.epiworld_model(abm)
...
ggsave(filename = "calibration/sir_infections_only-example.png", width = 1280/2, height = 500/2, units = "px", scale = 3)
